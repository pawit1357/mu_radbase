<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<input type="hidden" value="<?php echo $data->status;?>" name="Form8[status]" id="status" />
		<input type="hidden" value="<?php echo UserLoginUtils::getUserRoleName();?>" name="Form8[userRoleName]" id="userRoleName" />
...
<!-- 									class="form-control" name="Form8[name]"> -->
<!-- 							</div> -->
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea rows="5" cols="70" id="no_committee_reason"
									name="Form8[no_committee_reason]"><?php echo $data->no_committee_reason;?></textarea>
