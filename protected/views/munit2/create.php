...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MUnit2/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text"
									value="<?php echo MUnit2::getMax();?>"
									class="grpOfInt form-control" name="MUnit2[id]" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value=""
									class="form-control" name="MUnit2[name]">
							</div>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MUnit2/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
