						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text"
									value="<?php echo MRadioactiveElement::getMax();?>"
						...
						<div class="form-group">
							...
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" id="type"
									name="MRadioactiveElement[type]" value="1" checked="checked" /> ปิดผนึก
								</label> <label class="radio-inline"> <input type="radio"
									id="type" name="MRadioactiveElement[type]" value="2" />ไม่ปิดผนึก
								</label>
