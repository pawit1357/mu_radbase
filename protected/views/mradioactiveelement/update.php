...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MRadioactiveElement/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
		<div class="portlet-body form">
			<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo $data->id;?>"
									class="grpOfInt form-control" name="MRadioactiveElement[id]"
									readonly>
							</div>
				...
				<div class="row">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="MRadioactiveElement[name]">
							</div>
					...
					<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-4"> ประเภทสาร:<span
								class="required"> * </span>
							</label>
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" id="type"
									name="MRadioactiveElement[type]" value="1"
									<?php echo $data->type =='1'? "checked=checked":''; ?> />
									ปิดผนึก
								</label> <label class="radio-inline"> <input type="radio"
									id="type" name="MRadioactiveElement[type]" value="2"
									<?php echo $data->type =='2'? "checked=checked":''; ?> />ไม่ปิดผนึก
								</label>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MRadioactiveElement/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
