...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MUseType/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo $data->id;?>"
									class="form-control" name="MUseType[id]" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="MUseType[name]">
							</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->description?>" class="form-control"
									name="MUseType[description]">
							</div>
							<div id="divReq-name"></div>
						</div>
					</div>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MUseType/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
