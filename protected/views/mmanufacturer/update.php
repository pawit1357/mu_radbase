...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MManufacturer/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
		<div class="portlet-body form">
			<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo $data->id;?>"
									class="grpOfInt form-control" name="Manufacturer[id]" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="Manufacturer[name]">
							</div>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-4">ประเทศ:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="country_id" type="text"
									value="<?php echo $data->country_id;?>" class="form-control"
									name="Manufacturer[country_id]">
							</div>
							<div id="divReq-country_id"></div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MManufacturer/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
	 ...
	 $("#name").attr('maxlength','200');
    	$( "#Form1" ).submit(function( event ) {
        	...
        	if($("#country_id").val().length==0){
        		...
        		$("#divReq-country_id").html("<span id=\"name-error\" class=\"help-block help-block-error\">This field is required.</span>");
        		$("#country_id").focus();
        		return false;
                }else{
            	$("#divReq-country_id").html('');
...
// 		            $('#Manufacturer_id').append($('<option>').text("Select"));
// 		            $.each(json, function(i, obj){
// 		                    $('#Manufacturer_id').append($('<option>').text(obj.name).attr('value', obj.id));
// 		            });
