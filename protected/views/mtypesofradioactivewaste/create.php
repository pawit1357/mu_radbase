						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text"
									value="<?php echo MTypesOfRadioactiveWaste::getMax();?>"
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MMTypesOfRadioactiveWaste/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
