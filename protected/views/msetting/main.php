		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
					<?php echo (UserLoginUtils::canCreate($_SERVER['REQUEST_URI']) == false)? "":  CHtml::link('เพิ่มข้อมูล',array('MSetting/Create'),array('class'=>'btn btn-default btn-sm'));?>
					</div>
				</div>
...
<td class="center"><?php echo $counter;?></td>
								...
								<td class="center"><?php echo $data->value?></td>
								<td class="center">
...
<a title="Edit" class="fa fa-edit"
									href="<?php echo Yii::app()->CreateUrl('MSetting/Update/id/'.$data->id)?>"></a>
<?php }?>
<?php if(UserLoginUtils::canDelete( $_SERVER['REQUEST_URI'])){?>
<a title="Delete" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่?')"
									class="fa fa-trash"
									href="<?php echo Yii::app()->CreateUrl('MSetting/Delete/id/'.$data->id)?>"></a>
<?php }?>	
