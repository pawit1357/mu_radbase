<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MSetting/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
		<div class="portlet-body form">
			<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo $data->id;?>"
									class="grpOfInt form-control" name="MSetting[id]" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="MSetting[name]">
							</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">ค่า:<span class="required">*</span></label>
							<div class="col-md-6">
								<input id="value" type="text" value="<?php echo $data->value;?>"
									class="form-control" name="MSetting[value]">
							</div>
							<div id="divReq-value"></div>
						</div>
					</div>
				</div>
				<!-- END FORM-->
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MSetting/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
    ...
    jQuery(document).ready(function () {
    	...
    	$( "#Form1" ).submit(function( event ) {
        	...
        	if($("#value").val().length==0){
        		...
        		$("#divReq-value").html("<span id=\"name-error\" class=\"help-block help-block-error\">This field is required.</span>");
        		return false;
                }else{
            	$("#divReq-value").html('');
