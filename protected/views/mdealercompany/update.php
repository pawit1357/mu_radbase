...
<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('MDealerCompany/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text" value="<?php echo $data->id;?>"
									class="grpOfInt form-control" name="MDealerCompany[id]"
									readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="MDealerCompany[name]">
							</div>
					...
					<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-4">ที่อยู่:<span
								class="required">*</span></label>
							<div class="col-md-6">
								<input id="addr" type="text" value="<?php echo $data->addr?>" class="form-control"
									name="MDealerCompany[addr]">
							</div>
							<div id="divReq-addr"></div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('MDealerCompany/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
