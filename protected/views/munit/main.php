		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
					<?php echo (UserLoginUtils::canCreate($_SERVER['REQUEST_URI']) == false)? "":  CHtml::link('เพิ่มข้อมูล',array('MUnit/Create'),array('class'=>'btn btn-default btn-sm'));?>
					</div>
				</div>
...
<a title="Edit" class="fa fa-edit"
									href="<?php echo Yii::app()->CreateUrl('MUnit/Update/id/'.$data->id)?>"></a>
<?php }?>
...
<a title="Delete" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่?')"
									class="fa fa-trash"
									href="<?php echo Yii::app()->CreateUrl('MUnit/Delete/id/'.$data->id)?>"></a>
<?php }?>	
