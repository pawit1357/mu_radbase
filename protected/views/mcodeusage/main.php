...
<!-- 								<th>รหัส</th> -->
								...
								<th>รหัสประเภท</th>
								<th>ชื่อประเภท</th>
								<th>สำหรับ(เครื่องกำเนิดฯ/วัสดุกัมมันฯ)</th>
								<th>สำหรับ(ปิด/ไม่ปิดผนึก)</th>
								<th>สำหรับ(สาขา)</th>
								<th class="no-sort"></th>
							</tr>
						</thead>
	...
	foreach ( $dataProvider->data as $data ) {
		?>
				<tr>
								...
								<td class="center"><?php echo CommonUtil::getRadMachineName($data->is_rad_machine) ?></td>

								<td class="center"><?php echo CommonUtil::getSealTypeName($data->is_sealsource) ?></td>
