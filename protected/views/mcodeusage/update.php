					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<input id="id" type="text" value="<?php echo $data->code;?>" class="form-control" name="MCodeUsage[code]" >
						...
						<div class="form-group">
							...
							<div class="radio-list">
								...
								<input type="checkbox" id="status"
									name="is_rad_machine[]" value="1" <?php echo (strpos($data->is_rad_machine,"1") !== False)? 'checked="checked"':''?>
									onchange="onChangeRadOrMachine(this)" /> เครื่องกำเนิดรังสี
								
								<input type="checkbox"
									id="status" name="is_rad_machine[]" value="2" <?php echo (strpos($data->is_rad_machine,"2") !== False)? 'checked="checked"':''?>
									onchange="onChangeRadOrMachine(this)" />วัสดุกัมมันตรังสี
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="radio-list">
								<label class="radio-inline"> 
								<input type="checkbox" id="status"
									name="is_sealsource[]" value="1" <?php echo (strpos($data->is_sealsource,"1") !== False)? 'checked="checked"':''?> /> ปิดผนึก
								<input type="checkbox"
									id="status" name="is_sealsource[]" value="2" <?php echo (strpos($data->is_sealsource,"2") !== False)? 'checked="checked"':''?> />ไม่ปิดผนึก
								</label>
