...
<form id="Form1" method="POST" enctype="multipart/form-data"
		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
					<?php echo (UserLoginUtils::canCreate($_SERVER['REQUEST_URI']) == false)? "":  CHtml::link('เพิ่มข้อมูล',array('MRadMachine/Create'),array('class'=>'btn btn-default btn-sm'));?>
					</div>
				</div>
	...
	foreach ( $dataProvider->data as $data ) {
		?>
								...
								<td class="center"><?php echo (isset($data->code_usage->name)? $data->code_usage->name:'').' '.(isset($data->code_usage_other)? '('.$data->code_usage_other.')':'')?></td>
...
<a title="Edit" class="fa fa-edit"
									href="<?php echo Yii::app()->CreateUrl('MRadMachine/Update/id/'.$data->id)?>"></a>
<?php }?>
...
<a title="Delete" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่?')"
									class="fa fa-trash"
									href="<?php echo Yii::app()->CreateUrl('MRadMachine/Delete/id/'.$data->id)?>"></a>
<?php }?>		
