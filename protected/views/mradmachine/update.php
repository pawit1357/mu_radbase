						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="MRadMachine[name]">
							</div>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="seq" type="text" value="<?php echo $data->seq ?>"
						...
						<div class="form-group">
							...
							<div class="radio-list">
								...
								<?php foreach($branchs as $item) {?>
									...
									<?php echo (strpos($data->branch_group_id,$item->id) !== False)? 'checked="checked"':''?> /> <?php echo $item->name?>
